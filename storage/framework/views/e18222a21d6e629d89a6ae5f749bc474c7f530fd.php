<?php $__env->startSection('title', "Fil d'actualité"); ?>
                    ...
                    <div class="card shadow-sm rounded-3" id="post-<?php echo e($post->id); ?>">
                        ...
                        <div class="postImages <?php echo e($class); ?>">
                            ...
                            <div class="image-wrapper position-relative">
                                <a href="<?php echo e(route('app_affiche_image', ['post' => $post->id,'image' => $image->id])); ?>">
                                    <img src="<?php echo e(asset('storage/' . $image->image)); ?>" class="img-fluid">
                                </a>
